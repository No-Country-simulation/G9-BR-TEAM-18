...
class EnergyAnalysisServiceTest {
    ...
    void setUp() {
        ...
        applianceAggregationService = mock(ApplianceAggregationService.class, Mockito.RETURNS_DEEP_STUBS);

        service = new EnergyAnalysisService(repoMock, mlClientMock, applianceAggregationService);
    }
