# Análise: `threshold/LIGHTING_WATTS=1001`
...
- Substituir lâmpadas antigas por tecnologia LED de baixo consumo.
...
- ✅ probability_range: Probabilidade 0.7617 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 76.2%) reconhecida
