# Análise: `combinatorial/12-casa-media-alto-peak=false`
...
- ✅ probability_range: Probabilidade 0.78 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 78.0%) reconhecida
