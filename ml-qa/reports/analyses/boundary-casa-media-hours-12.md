# Análise: `boundary/casa-media/hours=12`
...
- ✅ probability_range: Probabilidade 0.7852 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 78.5%) reconhecida
