# Análise: `boundary/apartamento-medio/hours=0`
...
- ✅ probability_range: Probabilidade 0.5329 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 53.3%) reconhecida
