# Análise: `combinatorial/21-apartamento-compacto-esperado-peak=true`
...
- ✅ probability_range: Probabilidade 0.5193 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 51.9%) reconhecida
