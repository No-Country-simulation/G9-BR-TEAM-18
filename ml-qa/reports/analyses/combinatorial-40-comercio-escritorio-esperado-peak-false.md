# Análise: `combinatorial/40-comercio-escritorio-esperado-peak=false`
...
- ✅ probability_range: Probabilidade 0.4967 válida
- ✅ recommendations: 2 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 49.7%) reconhecida
