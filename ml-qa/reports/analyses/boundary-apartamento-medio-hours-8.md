# Análise: `boundary/apartamento-medio/hours=8`
...
- ✅ probability_range: Probabilidade 0.6248 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 62.5%) reconhecida
