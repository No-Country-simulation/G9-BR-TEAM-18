# Análise: `boundary/apartamento-medio/hours=12`
...
```json
{
  "consumption_kwh": 663.93,
  "peak_hour_usage": false,
  "equipment_quantity": 19,
  "property_type": "APARTAMENTO",
  "high_consumption_hours": 12.0,
...
- ✅ probability_range: Probabilidade 0.6267 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 62.7%) reconhecida
