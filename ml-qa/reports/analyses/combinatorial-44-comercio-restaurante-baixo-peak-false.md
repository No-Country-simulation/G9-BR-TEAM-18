# Análise: `combinatorial/44-comercio-restaurante-baixo-peak=false`
...
- ✅ probability_range: Probabilidade 0.7943 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 79.4%) reconhecida
