# Análise: `combinatorial/28-apartamento-medio-esperado-peak=false`
...
- ✅ probability_range: Probabilidade 0.4307 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 43.1%) reconhecida
