# Análise: `anomaly/edge/hours-max`
...
- ✅ probability_range: Probabilidade 0.6871 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 68.7%) reconhecida
