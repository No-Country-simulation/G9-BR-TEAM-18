# Análise: `boundary/casa-media/hours=0`
...
- ✅ probability_range: Probabilidade 0.721 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 72.1%) reconhecida
