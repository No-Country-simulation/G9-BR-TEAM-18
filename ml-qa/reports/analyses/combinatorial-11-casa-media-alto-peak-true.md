# Análise: `combinatorial/11-casa-media-alto-peak=true`
...
- ✅ probability_range: Probabilidade 0.5506 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 55.1%) reconhecida
