# Análise: `monotonic/comercio-loja/consumption=294.93`
...
- ✅ probability_range: Probabilidade 0.6992 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 69.9%) reconhecida
