# Análise: `combinatorial/20-apartamento-compacto-baixo-peak=false`
...
- ✅ probability_range: Probabilidade 0.7276 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 72.8%) reconhecida
