# Análise: `boundary/casa-media/hours=24`
...
- ✅ probability_range: Probabilidade 0.7028 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 70.3%) reconhecida
