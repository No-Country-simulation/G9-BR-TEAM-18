# Análise: `combinatorial/29-apartamento-medio-alto-peak=true`
...
- ✅ probability_range: Probabilidade 0.6123 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 61.2%) reconhecida
