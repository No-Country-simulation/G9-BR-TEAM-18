# Análise: `combinatorial/18-casa-grande-alto-peak=false`
...
- ✅ probability_range: Probabilidade 0.6195 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 61.9%) reconhecida
