# Análise: `combinatorial/16-casa-grande-esperado-peak=false`
...
- ✅ probability_range: Probabilidade 0.6441 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 64.4%) reconhecida
