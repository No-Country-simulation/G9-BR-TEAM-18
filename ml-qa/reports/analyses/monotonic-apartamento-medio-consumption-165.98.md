# Análise: `monotonic/apartamento-medio/consumption=165.98`
...
- ✅ probability_range: Probabilidade 0.7364 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 73.6%) reconhecida
