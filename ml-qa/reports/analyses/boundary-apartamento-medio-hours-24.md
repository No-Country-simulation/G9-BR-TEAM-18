# Análise: `boundary/apartamento-medio/hours=24`
...
- ✅ probability_range: Probabilidade 0.6375 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 63.7%) reconhecida
