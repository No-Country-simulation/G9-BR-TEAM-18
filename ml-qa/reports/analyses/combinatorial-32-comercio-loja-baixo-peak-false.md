# Análise: `combinatorial/32-comercio-loja-baixo-peak=false`
...
- ✅ probability_range: Probabilidade 0.6358 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 63.6%) reconhecida
