# Análise: `combinatorial/06-casa-basica-alto-peak=false`
...
- ✅ probability_range: Probabilidade 0.7931 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 79.3%) reconhecida
