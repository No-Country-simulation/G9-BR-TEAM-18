# Análise: `anomaly/edge/consumption-max`
...
- ✅ probability_range: Probabilidade 0.7613 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 76.1%) reconhecida
