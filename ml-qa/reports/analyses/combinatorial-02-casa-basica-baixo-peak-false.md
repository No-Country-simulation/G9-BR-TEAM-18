# Análise: `combinatorial/02-casa-basica-baixo-peak=false`
...
- ✅ probability_range: Probabilidade 0.782 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 78.2%) reconhecida
