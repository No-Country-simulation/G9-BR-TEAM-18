# Análise: `monotonic/comercio-loja/consumption=589.86`
...
- ✅ probability_range: Probabilidade 0.4836 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 48.4%) reconhecida
