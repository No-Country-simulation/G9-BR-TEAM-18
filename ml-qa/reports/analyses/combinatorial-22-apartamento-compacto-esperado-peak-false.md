# Análise: `combinatorial/22-apartamento-compacto-esperado-peak=false`
...
- ✅ probability_range: Probabilidade 0.4134 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 41.3%) reconhecida
