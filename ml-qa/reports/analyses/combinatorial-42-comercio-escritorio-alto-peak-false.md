# Análise: `combinatorial/42-comercio-escritorio-alto-peak=false`
...
- ✅ probability_range: Probabilidade 0.5818 válida
- ✅ recommendations: 2 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 58.2%) reconhecida
