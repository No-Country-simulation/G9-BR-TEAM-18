# Análise: `combinatorial/47-comercio-restaurante-alto-peak=true`
...
- ✅ probability_range: Probabilidade 0.6753 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 67.5%) reconhecida
