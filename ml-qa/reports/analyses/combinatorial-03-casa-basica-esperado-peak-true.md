# Análise: `combinatorial/03-casa-basica-esperado-peak=true`
...
- ✅ probability_range: Probabilidade 0.6491 válida
- ✅ recommendations: 5 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 64.9%) reconhecida
