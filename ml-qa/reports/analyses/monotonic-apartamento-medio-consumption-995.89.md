# Análise: `monotonic/apartamento-medio/consumption=995.89`
...
- ✅ probability_range: Probabilidade 0.7308 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 73.1%) reconhecida
