# Análise: `anomaly/edge/consumption-above-set`
...
- ✅ probability_range: Probabilidade 0.614 válida
- ✅ recommendations: 4 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 61.4%) reconhecida
