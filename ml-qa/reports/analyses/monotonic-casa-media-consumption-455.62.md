# Análise: `monotonic/casa-media/consumption=455.62`
...
- ✅ probability_range: Probabilidade 0.5768 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 57.7%) reconhecida
