# Análise: `combinatorial/26-apartamento-medio-baixo-peak=false`
...
- ✅ probability_range: Probabilidade 0.7703 válida
- ✅ recommendations: 3 recomendações válidas
- ✅ source_valid: Fonte model+rule-based (groq failed) (confidence 77.0%) reconhecida
